...
ActiveRecord::Schema.define(version: 2022_02_25_112936) do
  ...
  create_table "menu_beverages_meals", id: false, force: :cascade do |t|
    ...
    t.index ["menu_beverage_id"], name: "index_menu_beverages_meals_on_menu_beverage_id"
    t.index ["menu_meal_id"], name: "index_menu_beverages_meals_on_menu_meal_id"
  end
